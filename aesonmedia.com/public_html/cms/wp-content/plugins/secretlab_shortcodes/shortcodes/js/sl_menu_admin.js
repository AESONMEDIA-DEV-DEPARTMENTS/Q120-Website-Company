...
(function($) {
    ...
    var sl_menu = {
        ...
        menu_type_options: function () {
            ...
            jQuery(document).on('click', '.sl_menu_type',
                function () {
                    var $this = jQuery(this);
                    var type = $this.val();
                    var parent = $this.parents('.sl_menu_item'), innerDivs, innerSpans;
                    ...
                    //$(innerDivs).css({'display' : 'block'}); $(innerSpans).css({'display' : 'block'});

                    if (type == 'search') {
                        var lik_settings_block = $this.parents('.menu-item-settings').find('.admin-sl-box-menu-item-settings');
        ...
        fullwidth_checkbox_click: function () {
            ...
            jQuery(document).on('change', '.menu-item-seclab-mega_menu_fullwidth',
                function () {
