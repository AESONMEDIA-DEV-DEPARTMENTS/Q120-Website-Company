...
Contributors: dale668, secretlabpw
Donate link: https://secretlab.pw/donation/
Tags: marketing booster, SEO titles, lazy load, A|B test, analytics codes, icons fonts manager
...
Marketing and SEO booster WordPress plugin
...
1. Upload the plugin files to the `/wp-content/plugins/marketing-and-seo-booster` directory, or install the plugin through the WordPress plugins screen directly.
2. Activate the plugin through the 'Plugins' screen in WordPress.
3. Use the Marketing page to select the plugin's modules (By default, all modules active).
4. Use the Marketing submenu pages to configure every enabled module.
...
1. General plugin settings with modules selections.
2. Code editor for "Analytics Codes" addition.
3. Settings and statistics of "ABC Test".
