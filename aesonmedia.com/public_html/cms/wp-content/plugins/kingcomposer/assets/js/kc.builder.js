			...
			right_click : function (e) {
				...
				if (ob.length > 0) {
					...
					*/
                    ...
                    words = name.replace(/kc\_/g,'').split('_');
                    word = words[0];
                    for (var i = 1; i < words.length; i++) {
                        word = word + words[i][0].toUpperCase()+words[i].slice(1);
                    }
                    actions = {
							edit: '<li data-act="edit"><i class="fa-edit"></i> '+kc.__.edit+'</li>',
							insert: '<li data-act="insert"><i class="fa-columns"></i> '+kc.__.aiL10n.new+' '+kc.__.aiL10n[word]+'</li>',
							copy:  '<li data-act="copy"><i class="fa-copy"></i> '+kc.__.copy+' '+
										'<ul class="sub">'+
											'<li data-act="copystyle"><i class="fa-paint-brush"></i> '+
                            kc.__.aiL10n.copyStyleOnly+'</li>'+
										'</ul></li>',
							copystyle: '<li data-act="copystyle"><i class="fa-paint-brush"></i> '+kc.__.aiL10n.copyStyleOnly+'</li>',
							paste:  '<li data-act="paste"><i class="fa-paste"></i> '+kc.__.paste+' '+
										'<ul class="sub">'+
											'<li data-act="pastestyle"><i class="fa-paint-brush"></i> '+
                            kc.__.aiL10n.pasteStyleOnly+'</li>'+
										'</ul></li>',
							double: '<li data-act="double"><i class="fa-clone"></i> '+kc.__.aiL10n.double+'</li>',
							add: '<li data-act="add"><i class="fa-plus"></i> '+kc.__.aiL10n.addElements+'</li>',
							cut: '<li data-act="cut"><i class="fa-cut"></i> '+kc.__.aiL10n.cut+'</li>',
							clear: '<li data-act="clear"><i class="fa-eraser"></i> '+kc.__.aiL10n.clearStyle+'</li>',
							delete: '<li data-act="delete"><i class="fa-trash"></i> '+kc.__.delete+'</li>'
						};
