...
class Atiframebuilder_Core {
	...
	public function __construct( $theme ) {
		...
		if ( ! class_exists( 'KingComposer' ) ) {
			add_action( 'wp_enqueue_scripts', array( $this, 'save_css' ), 10000 );
		}
...
//			require 'inc/class-config.php';
	...
	public function set_plugins() {
		...
		if ( class_exists( 'SECL_Installer' ) ) {
			require get_template_directory() . '/framework/inc/class-plugins-list.php';
			$this->plugins = new Atiframebuilder_Plugins();
		} else {
			require get_template_directory() . '/framework/inc/class-plugins-list_f.php';
