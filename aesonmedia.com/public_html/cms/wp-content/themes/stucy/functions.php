...
class Stucy_Theme {
	...
	public function theme_setup() {
		 ...
		 * replace to change 'stucy' to the name of your theme in all
		 * template files.
		 */
		load_theme_textdomain( 'stucy', get_template_directory() . '/languages' );

		// This theme uses wp_nav_menu() in one location.
		register_nav_menu( 'atiframebuilder_top_menu', esc_attr__( 'Header Menu', 'stucy' ) );
...
global $atiframe_theme;
$atiframe_theme = Stucy_Theme::get_instance();
